  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[#f5f1eb] via-[#ede8e0] to-[#e8e0d6]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 sm:px-8 py-12 sm:py-16 space-y-10 sm:space-y-12">
        ...
        {/* Account Name Info */}
        <div className="bg-white/30 backdrop-blur-2xl rounded-2xl p-7 sm:p-8 text-center shadow-2xl border border-white/30 animate-slide-up-delay-4 backdrop-saturate-150">
          <p className="text-base sm:text-lg text-[#8B4513] mb-4">اسم الحساب • Account Holder Name:</p>
          <p className="font-bold text-[#5C4033] text-2xl sm:text-3xl">نجيب سليم وشركاه</p>
          <p className="text-lg sm:text-xl text-[#8B4513] mt-3">Naguib Seliem & Co.</p>
        </div>

        {/* Next Steps */}
        <div className="bg-white/30 backdrop-blur-2xl rounded-2xl p-7 sm:p-8 space-y-5 border border-white/30 animate-slide-up-delay-5 shadow-2xl backdrop-saturate-150">
        ...
        {/* WhatsApp Button */}
        <a href="http://wa.me/201225020005" target="_blank" rel="noopener noreferrer" className="block w-full animate-slide-up-delay-6">
          <Button
            size="lg"
        ...
        <div className="text-center space-y-4 py-8 sm:py-10 border-t-2 border-[#D2B48C]/50">
          ...
          <p className="text-lg sm:text-xl text-[#5C4033] font-bold">Naguib Seliem • Fabrics & More</p>
        </div>
      </div>
